...
/* ALIENTEK-style short type aliases used throughout this driver */
typedef uint8_t  u8;
...
//////////////////////////////////////////////////////////////////////////////////
//-----------------LCD端口定义----------------
/* LCD背光 PB15: set/clear GPIOB ODR bit 15. Usage: LCD_LED=1; / LCD_LED=0; */
#define LCD_LED_SET(v)  do { if (v) GPIOB->ODR |= (1U<<15); else GPIOB->ODR &= ~(1U<<15); } while(0)
#define LCD_LED         (*(volatile uint32_t*)(0x42000000 + ((0x40020414-0x40000000)*32) + (15*4)))  /* PB15 bit-band */
//LCD地址结构体
typedef struct
{
	vu16 LCD_REG;
